...
export interface EditMigratedConstructionContractFileParams {
    id: number | null;
    // 設計書
    ...
    // 検査調書
    migrated_handover_document_base64: string | null;
    migrated_handover_document_name: string | null;
...
export interface EditMigratedConstructionContractFileForm {
    id: number | null;
    // 設計書
    ...
    // 検査調書
    migratedHandoverDocumentBase64: string | null;
    migratedHandoverDocumentName: string | null;
    migratedHandoverDocumentInfo: AttachmentInfo;
    // 工事管理シート
...
export class EditMigratedConstructionFile {
    static createEmptyForm(): EditMigratedConstructionContractFileForm {
        return {
            id: null,
            specFileBase64: null,
            specFileName: null,
            ...
            migratedHandoverDocumentBase64: null,
            migratedHandoverDocumentName: null,
            migratedHandoverDocumentInfo: null,
    ...
    static contractToForm(
        ...
        return {
            ...
            migratedHandoverDocumentBase64: null,
            migratedHandoverDocumentName: null,
            migratedHandoverDocumentInfo: contract.migratedHandoverDocumentInfo,
            manageSheetBase64: null,
            manageSheetName: null,
    ...
    static formToContractParams(
        forms: EditMigratedConstructionContractFileForm[],
        ...
        return forms.map(form => {
            return {
                ...
                migrated_handover_document_base64:
                    form.migratedHandoverDocumentBase64,
                migrated_handover_document_name:
                    form.migratedHandoverDocumentName,
                migrated_handover_document_info:
                    form.migratedHandoverDocumentInfo,
